...
class XTCE_Communication(App):
    ...
    def __init__(self, airliner_map, address='localhost',
        ...
        """
        super(XTCE_Communication, self).__init__()
    ...
    def attach(self, vehicle):
        super(XTCE_Communication, self).attach(vehicle)
        self.control_thread = RealTimeThread(
            name='ControlRotateThread', target=self.control_rotate,
            every=XTCE_Communication.CONTROL_ROTATE_EVERY)
    ...
    def detach(self):
        ...
        super(XTCE_Communication, self).detach()
    ...
    def control_grant(self):
        ...
        for app_name in get_or_stop():
            ...
            try:
                ...
                )).first(XTCE_Communication.CONTROL_ACK_WAIT).result
                ...
                self.error('{} did not acknowledge control handoff within '
                           '{} seconds.'.format(
                                app_name, XTCE_Communication.CONTROL_ACK_WAIT))
                self.control_revoke()
                continue
            else:
    ...
    def get_app(self, app_ops_name, ops_names: list):
    ...
    def _get_airliner_op(self, op_path):
        ...
        return self.get_app(ops_names[1])['operations'][ops_names[2]]
    ...
    def _serialize(self, telemetry):
        ...
        serial_cmd = XTCE_Communication.serialize(header, payload)
        return serial_cmd
